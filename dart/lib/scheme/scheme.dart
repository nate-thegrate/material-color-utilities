...
class Scheme {
  ...
  Scheme.light(int color) : this.lightFromCorePalette(CorePalette.of(color));

  Scheme.dark(int color) : this.darkFromCorePalette(CorePalette.of(color));

  Scheme.lightContent(int color)
      : this.lightFromCorePalette(CorePalette.contentOf(color));

  Scheme.darkContent(int color)
      : this.darkFromCorePalette(CorePalette.contentOf(color));

  Scheme.lightFromCorePalette(CorePalette palette)
      : this(
  ...
  Scheme.darkFromCorePalette(CorePalette palette)
      : this(
